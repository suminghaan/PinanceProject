							...
							<div class="card-body">
								<section class="board-insert">
									<div class="container">
										...
										<form id="frm" action="${contextPath}/board/modify.do?no=${board.postNo}" method="post" style="margin-top: 50px;" enctype="multipart/form-data">
											...
											<table class="table" style="font-size: large;">
												...
												<tr>
													...
													<td><input type="text" id="title" class="form-control" name="postTitle" value="${board.postTitle}" required></td>
												</tr>
												...
												<tr>
													<th colspan="2">
														<div class="mb-2 row">
															...
															<div class="col-md-10">
																<input type="file" class="form-control" id="example-fileinput" style="margin-left: 6.5%; width: 93.5%" name="uploadFiles" multiple>
																<span style="margin-left: 7%; font-size: small;">현재 업로드된 파일 : </span><br>
																 
																 <c:forEach var="at" items="${ board.attachList }">
																	 <div>
	                                		<a href="${ contextPath }${at.filePath}/${at.filesystemName}" download="${ at.originalName }" style="font-size: small; margin-left: 7%;">${ at.originalName }</a>
	                                		<span class="origin_del" data-fileno="${ at.fileNo }" style="cursor: pointer;">x</span><br>
												...
												<tr>
													<th colspan="2"><textarea name="postContent" id="editorTxt" style="width: 100%;">${board.postContent}</textarea></th>
												</tr>
												
											</table>
											<br>
											<div align="center">
												<button style="margin-right: 2px" class="btn btn-primary" onclick="submitPost();">수정하기</button>
												<a class="btn btn-outline-secondary waves-effect" href="${contextPath}/board/boardDetail.do?no=${board.postNo}">취소하기</a>
											</div>
										</form>
									</div>
								</section>

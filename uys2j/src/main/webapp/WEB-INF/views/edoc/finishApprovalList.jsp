          ...
          <div class="row">
              <div class="col-12">
                  <div class="page-title-box page-title-box-alt">
                      <h4 class="page-title">결재완료함</h4>
                      <div class="page-title-right">
                          <ol class="breadcrumb m-0">
                              <li class="breadcrumb-item"><a href="javascript: void(0);">전자결재</a></li>
                              <li class="breadcrumb-item"><a href="javascript: void(0);">결재완료함</a></li>
                          </ol>
                      </div>
                  </div>
              </div>
          ...
          <div class="row">
              <div class="col-12">
                  <div class="card" style="border: 1px solid #4A55A2; width: 98%; margin-left: auto; margin-right: auto; border-radius: 10px;">
                      <div class="card-body">
                          <h4 class="header-title">결재완료함</h4>
                          <p class="sub-header">
                           결재 완료 목록
                          </p>
                          ...
                          <div class="table-responsive">
                              <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="10">
                                  ...
                                  <tr>
                                      ...
                                      <th>제목</th>
                                      <th data-hide="phone">기안일</th>
                                      <th data-hide="phone, tablet">결재완료일</th>
                                  ...
                                  <tbody>
                                  	<c:forEach var="edoc" items="${list}">
	                                      ...
	                                      <td>
	                                      	<c:choose>
	                                      		<c:when test="${edoc.status eq 'A'}">
	                                      			<span class="badge label-table bg-success">승인</span>
	                                      		</c:when>
	                                      		<c:otherwise>
	                    		                    <span class="badge label-table bg-secondary text-light">반려</span>	                                     			
	                                      		</c:otherwise>
	                                      	</c:choose>
	                                      </td>
	                                  	</tr>
